...
export class Card extends Component {
  ...
  render () {
    ...
    return (
      <div className="col-xl-4 animated fadeIn card-hover" key={this.props.id}>
            ...
            <div className="container">
              <div className="row">
                <div className="btn-group btn-group-sm col-lg-12" >
                  ...
                  <a href={this.props.githubLink} className="btn btn-success text-center col-lg-6" role="button" target="_blank" aria-pressed="true">Play</a>
                </div>
              </div>
            </div>
          </div>
